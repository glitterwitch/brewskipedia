...
var async, build, colors, commonOptions, commonUsage, extend, fileExists, fs, getOptions, logger, options, path, rimraf, usage, wintersmith, _ref, _ref1;
...
_ref1 = require('./common'), getOptions = _ref1.getOptions, commonOptions = _ref1.commonOptions, commonUsage = _ref1.commonUsage, fileExists = _ref1.fileExists;
...
build = function(argv) {
  ...
  return async.waterfall([
    async.apply(getOptions, argv), function(options, callback) {
      return async.waterfall([
        function(callback) {
          return fileExists(options.output, function(exists) {
            if (exists) {
              return callback();
            } else {
