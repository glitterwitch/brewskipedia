...
var ContentPlugin, Page, async, extend, marked, moment, path, stripExtension, underscore, _ref,
...
_ref = require('./../common'), stripExtension = _ref.stripExtension, extend = _ref.extend;
...
Page = (function(_super) {
  ...
  */
  ...
  Page.prototype.getIntro = function(base) {
    var idx, _ref1;
    if ((_ref1 = this._html) == null) {
      this._html = this.getHtml(base);
    }
    idx = ~this._html.indexOf('<span class="more') || ~this._html.indexOf('<h2') || ~this._html.indexOf('<hr');
    if (idx) {
      this._intro = this._html.substr(0, ~idx);
    } else {
      this._intro = this._html;
    }
    return this._intro;
  };
  ...
  Page.property('hasMore', function() {
    ...
    if ((_ref2 = this._intro) == null) {
      this._intro = this.getIntro();
    }
    if ((_ref3 = this._hasMore) == null) {
